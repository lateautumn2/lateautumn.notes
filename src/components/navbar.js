...
export default function Navbar() {
  return (
    <header className="flex items-center justify-between py-3 mx-auto w-full">
      <div>
      ...
      <div className="flex items-center text-base leading-5">
        <Link href="/search" aria-label="Search">
          <svg className="h-5 w-5 mb-1 mx-1 text-zinc-500 dark:text-zinc-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
